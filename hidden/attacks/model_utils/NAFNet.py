...
# -----------------------------------------------------------------------------------
# For deblurring model construction
...
class NAFNetDeblurModel:
    ...
    def __init__(self, load_path):
        ...
        # config defined in https://github.com/megvii-research/NAFNet/blob/main/options/test/GoPro/NAFNet-width32.yml
        opt = dict(
            width=32,
